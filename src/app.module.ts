...
export class AppModule implements NestModule {
  //Aqui implemento los middlewares
  //Configuracion de todos los middlewares
  configure(consumer: MiddlewareConsumer) {
    consumer
      .apply(ExampleMiddleware)
      .forRoutes({ path: '*', method: RequestMethod.ALL }); //Aqui implemento las rutas de aplicacion y los metodos posibles para mi middleware
  }
}
